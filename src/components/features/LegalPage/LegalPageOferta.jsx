        ...
        <Flex direction={"column"} gap={"xl"}>
          <Flex direction={"column"} gap={"md"}>
            ...
            <Flex direction={"column"} pl={"md"}>
              ...
              <Text className={classes.text}>
                ...
                vereteno-hats.ru ОГРН 307616104500078, ИНН 616400036661адрес: г.
                Ростов-на-дону, ул. Курская д.15 Адрес магазина розничной
          ...
          <Flex direction={"column"}>
            ...
            >
              ...
              <List.Item>
                ...
                Продавца по телефону: +79034331144 либо по адресу электронной
          ...
          <Flex direction={"column"}>
            ...
            >
              ...
              <List.Item>
                обратиться в Клиентский центр по телефону + 79034331144 л
          ...
          <Flex direction={"column"}>
            ...
            >
              ...
              <List.Item>Савченко Дмитрий Никола</List.Item>
              ...
              <List.Item>ул. Курская д. 15</List.Item>
              <List.Item>
                Почтовый адрес: 344039 г. Ростов-наДону ул. Курская д. 15
              </List.Item>
              ...
              <List.Item>г. Ростов-наДону</List.Item>
              <List.Item>ИНН/КПП 7707083893 / 616443001</List.Item>
            </List>
          </Flex>
        </Flex>
      </Paper>
