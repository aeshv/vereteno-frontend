    ...
    <>
      <Paper shadow="xs" p="md">
        ...
        <Text size="sm">
          ...
          данных и меры по обеспечению безопасности и защиты персональных
          данных, предпринимаемые ООО Компания (далее – Оператор). 1.2. Оператор
          ...
          неприкосновенность частной жизни, личную и семейную тайну. 1.3.
          ...
          может получить о посетителях веб-сайта https://best-shop.robo.market.
          2. Основные термины и понятия, используемые в Политике 2.1.
          ...
          адресу https://best-shop.robo.market. 2.4. Информационная система
          ...
          https://best-shop.robo.market. 2.9. Персональные данные, разрешенные
          ...
          https://best-shop.robo.market. 2.11. Предоставление персональных
          ...
          не вправе далее продолжать обработку персональных данных без согласия
          субъекта персональных данных, за исключением оснований, указанных в
          ...
          требовать от Оператора уточнения их персональных данных, их
          ...
          законодательством РФ. 5. Перечень обрабатываемых персональных данных
          5.1. Оператор может обрабатывать следующие персональные данные
          Пользователя: — Фамилия, имя, отчество субъекта персональных данных; —
          Электронный адрес; — Номера телефона. 5.2. На сайте в том числе
          происходит сбор и обработка обезличенных данных о посетителях (в т.ч.
          файлов «cookies») с помощью сервисов интернет-статистики (Яндекс
          Метрика и Гугл Аналитика и других). 5.3. Вышеперечисленные данные
          далее по тексту Политики объединены общим понятием Персональные
          данные. 5.4. Обработка специальных категорий персональных данных,
          касающихся расовой, национальной принадлежности, политических
          взглядов, религиозных или философских убеждений, интимной жизни,
          Оператором не осуществляется. 5.5. Обработка персональных данных,
          ...
          предусмотренные ст. 10.1 Закона о персональных данных. 5.6. Согласие
          ...
          органом по защите прав субъектов персональных данных. 5.6.1. Согласие
          на обработку персональных данных, разрешенных для распространения,
          Пользователь предоставляет Оператору непосредственно в момент нажатия
          на кнопку «Оплатить заказ» на веб-сайте https://best-shop.robo.market.
          ...
          распространения. 5.6.3. Передача (распространение, предоставление,
          ...
          которому оно направлено. 5.6.4. Согласие на обработку персональных
          данных, разрешенных для распространения, прекращает свое действие с
          момента поступления Оператору требования, указанного в п. 5.6.3.
          настоящей Политики в отношении обработки персональных данных. 6.
          Принципы обработки персональных данных 6.1. Обработка персональных
          данных осуществляется на законной и справедливой основе. 6.2.
          ...
          собой. 6.4. Обработке подлежат только персональные данные, которые
          отвечают целям их обработки. 6.5. Содержание и объем обрабатываемых
          ...
          https://best-shop.robo.market. 7.2. Обезличенные данные Пользователей,
          собранные с помощью сервисов интернет-статистики, служат для сбора
          информации о действиях Пользователей на сайте, улучшения качества
          сайта и его содержания. 8. Правовые основания обработки персональных
          данных 8.1. Правовыми основаниями обработки персональных данных
          Оператором являются: — Федеральный закон "Об информации,
          информационных технологиях и о защите информации" от 27.07.2006 №
          149-ФЗ; — Федеральный закон №152-ФЗ от 27.07.2006 г. «О персональных
          данных», иные нормативно-правовые акты в сфере защиты персональных
          данных; — согласия Пользователей на обработку их персональных данных,
          на обработку персональных данных, разрешенных для распространения.
          ...
          https://best-shop.robo.market или направленные Оператору посредством
          ...
          Пользователя (включено сохранение файлов «cookies» и использование
          технологии JavaScript). 8.4. Субъект персональных данных
          самостоятельно принимает решение о предоставлении его персональных
          данных и дает согласие свободно, своей волей и в своем интересе. 9.
          Условия обработки персональных данных 9.1. Обработка персональных
          данных осуществляется с согласия субъекта персональных данных на
          обработку его персональных данных. 9.2. Обработка персональных данных
          ...
          функций, полномочий и обязанностей. 9.3. Обработка персональных данных
          ...
          исполнительном производстве. 9.4. Обработка персональных данных
          необходима для исполнения договора-оферты, стороной которого либо
          ...
          или обязательному раскрытию в соответствии с федеральным законом. 10.
          Порядок сбора, хранения, передачи и других видов обработки
          персональных данных 10.1. Безопасность персональных данных, которые
          ...
          персональных данных. 10.2. Оператор обеспечивает сохранность
          персональных данных и принимает все возможные меры, исключающие доступ
          к персональным данным неуполномоченных лиц. 10.3. Персональные данные
          ...
          исполнения обязательств по гражданско-правовому договору. 10.4. В
          ...
          уведомление на адрес электронной почты Оператора hello@company.com с
          пометкой «Актуализация персональных данных». 10.5. Срок обработки
          ...
          адрес Оператора hello@company.com с пометкой «Отзыв согласия на
          обработку персональных данных». 10.6. Вся информация, которая
          ...
          настоящем пункте поставщиков услуг. 10.7. Установленные субъектом
          ...
          законодательством РФ. 10.8. Оператор при обработке персональных данных
          обеспечивает конфиденциальность персональных данных и реализует все
          необходимые меры по защите персональных данных. 10.9. Оператор
          ...
          субъект персональных данных. 10.10. Условием прекращения обработки
          персональных данных может являться достижение целей обработки
          персональных данных (исполнение договора-оферты), истечение срока
          ...
          Оператором с полученными персональными данными 11.1. Оператор
          ...
          персональных данных 13.1. Оператор и иные лица, получившие доступ к
          ...
          почты hello@company.com. 14.2. В данном документе будут отражены любые
          ...
          адресу https://best-shop.robo.market/privacy. СОГЛАСИЕ НА ОБРАБОТКУ
          ПЕРСОНАЛЬНЫХ ДАННЫХ Настоящим я, Плательщик, (физическое лицо,
          осуществляющее безналичное перечисление денежных средств c
          использованием электронного средства платежа), авторизуясь на
          платежной странице сайта https://best-shop.robo.market и нажимая
          кнопку «Оформить заказ», в соответствии с требованиями Федерального
          закона от 27 июля 2006 года № 152-ФЗ «О персональных данных», даю своё
          СОГЛАСИЕ на обработку моих персональных данных ООО Компания (далее по
          тексту - Компания), ОГРН: 1234567890123 При этом под моими
          персональными данными понимаются: — ФИО (фамилия, имя, отчество); —
          адрес электронной почты; — номер мобильного телефона. В соответствии с
          условиями Политики обработки персональных данных Компания вправе
          осуществлять обработку моих персональных данных любыми необходимыми
          способами, включая сбор, систематизацию, накопление, хранение,
          изменение, дополнение, использование, распространение, передачу,
          трансграничную передачу, предоставление, доступ, блокирование,
          обезличивание, уничтожение персональных данных для достижения
          следующих целей: — осуществления безналичных расчетов с использованием
          электронного средства платежа в пользу Компании (Получателя) при
          формировании Плательщиком заказа на приобретение товара и\или услуги
          на web сайте Интернет-магазина Компании (Получателя); — обеспечения
          соблюдения законов и иных нормативных правовых актов Российской
          Федерации в области защиты персональных данных. Компания принимает все
          необходимые меры по обеспечению безопасности и защиты персональных
          данных Плательщика от несанкционированного доступа третьих лиц, а
          также любых иных неправомерных действий в отношении его персональных
          данных.
        </Text>
      </Paper>
    </>
